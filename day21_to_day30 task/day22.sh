...
# However, the Nautilus application development team now requires a copy of this repository on 
# the Storage Server in the Stratos DC. Follow the provided details to clone the repository:
...
the natasha user, and ensure that no modifications are made to the repository or existing directories, 
