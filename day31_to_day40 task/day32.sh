...
# the following requirements with DevOps team:
...
branch without loosing any data from the feature branch, also they do not want to add any merge commit by simply merging 
...
sudo git push origin -f feature
