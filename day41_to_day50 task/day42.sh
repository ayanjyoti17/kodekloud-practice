...
# One of the team members has been assigned a ticket where he has been asked to create some docker networks 
# to be used later. Complete the task based on the following ticket description:
...
docker network create -d macvlan --subnet=192.168.30.0/24 --ip-range=192.168.30.0/24 official
